...
">
    ...
    <div class="position-relative hires" style="overflow:hidden;">

        <!-- <div class="position-absolute"></div> -->
        <div class="position-absolute hires" style="background-image: url('assets/img/Landing-page.png');background-position: bottom; z-index:3;width:100%;background-repeat: repeat-x;    background-size: cover;">
        </div>
        <div class="position-absolute hires" style="background: #00000078;z-index: 2;width:100%;">
        </div>
        <div class="position-absolute hires" style="z-index: 1;width:100%;">
            <!-- <img class="h-100 img-main" src="assets/img/hp4-slider3-1170x770-1.png" alt="" style="width:100%;"> -->
            <!-- <div class="hires" style="object-fit: cover;"> -->
            <iframe width="100%" height="1080" style="
    display: block;
    margin: 0 auto;
    object-fit: cover;
" src="https://www.youtube.com/embed/sxTJfEua_Fw?playlist=sxTJfEua_Fw&loop=1autoplay=1&mute=1&loop=1&showinfo=0&controls=0"  frameborder="0" allowfullscreen>
                </iframe>
                <!-- <img src="assets/img/hp4-slider3-1170x770-1.png" class="w-100" style="
        max-height: 300px;
        ...
        <div class="position-absolute logo-strip" style="z-index: 999;bottom:-3px;">
            <img class="strip" src="assets/img/3@2x.png" width="500px" alt="">
        </div>
    ...
    <div class="position-relative hires" style="height: 1080px;
    background-color: #153116;background-image: url('assets/img/Page-Root.png');background-repeat: repeat-x; background-position: top; z-index:999;overflow:hidden;background-size: cover;">
       ...
       <img src="assets/img/image-asset.png" alt="" style="height: 100vh;">
        ...
        <div class="position-absolute logo-strip" style="z-index: 999;top:0;">
            <img class="strip" src="assets/img/2@2x.png" width="500px" height="1080" alt="">
        </div>
    ...
    background-color: #fff; z-index:999;overflow:hidden;">
        <div class="position-absolute logo-strip" style="z-index: 999;top:0;">
            <img class="strip" src="assets/img/4@2x.png" width="500px" height="1080" alt="">
        </div>
    ...
    <div class="welcome position-relative" style="background-color:#fff; z-index:999;overflow:hidden;">
        <div class="position-absolute logo-strip" style="z-index: 999;top:0;">
            <img class="strip" src="assets/img/5@2x.png" width="500px" height="1080" alt="" style="filter:invert(1);">
        </div>
        <div class="container-ar position-relative" style="z-index: 9999;">
            <div class="row justify-content-between">
  ...
  overflow: hidden;">
    ...
    <div class="welcome position-relative" style="background-color:#cccccc; z-index:999;overflow:hidden;">
        <div class="position-absolute logo-strip" style="z-index: 999;top:0;">
            <img class="strip" src="assets/img/5@2x.png" width="500px" height="1080" alt="">
        </div>
        <div class="container-ar position-relative" style="z-index: 9999;">
            <div class="row justify-content-between">
...
<img src="assets/img/DemokreatifPortrait1-150x150-1.jpg" class="rounded-circle mb-3 mx-auto d-block" alt="...">
    ...
    <div class="position-relative" style="background-color:#fff; padding-top:200px;padding-bottom:200px; z-index:999;overflow:hidden;">
        <div class="position-absolute logo-strip" style="z-index: 999;top:0;">
            <img class="strip" src="assets/img/5@2x.png" width="500px" height="3080" alt="" style="filter:invert(1);">
        </div>
        <div class="container-ar position-relative" style="z-index: 9999;">
